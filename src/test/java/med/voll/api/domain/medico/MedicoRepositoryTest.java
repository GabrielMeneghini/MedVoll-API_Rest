...
class MedicoRepositoryTest {
    ...
    void escolherMedicoAleatorioDisponivelCenario1() {
        var proximaSegundaAs10 = LocalDate.now()
                ...
                .atTime(10, 0);
        var medico = cadastrarMedico("Medico Teste", "medicoTeste@voll.med", "123456", Especialidade.CARDIOLOGIA);
        var paciente = cadastrarPaciente("Paciente Teste", "pacienteTeste@voll.med", "12345678910");
    ...
    private void cadastrarConsulta(Medico medico, Paciente paciente, LocalDateTime dataHora) {
        testEntityManager.persist(new Consulta(null, paciente, medico, dataHora, null));
    }
